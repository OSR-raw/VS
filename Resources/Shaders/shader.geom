...
void EmitCube( vec4 pos, vec4 color, uint in_code )
{
	...
	//3,1,7,5
		...
		transVerts[1].y = -193.0;
		transVerts[1]= (pvm)*transVerts[1];
		transVerts[3]= (pos + cubeVerts[3]);
		transVerts[3].y = -193.0;
		transVerts[3]= (pvm)*transVerts[3];
		transVerts[7]= (pos + cubeVerts[7]);
		transVerts[7].y = -193.0;
		transVerts[7]= (pvm)*transVerts[7];
		transVerts[5]= (pos + cubeVerts[5]);
		transVerts[5].y = -193.0;
		transVerts[5]= (pvm)*transVerts[5];
